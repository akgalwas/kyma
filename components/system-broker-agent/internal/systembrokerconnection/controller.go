...
func startController(mgr manager.Manager, reconciler reconcile.Reconciler) error {
	...
	return c.Watch(&source.Kind{Type: &v1alpha1.SystemBrokerConnection{}}, &handler.EnqueueRequestForObject{})
}
...
func shouldResyncConfig(connection *v1alpha1.SystemBrokerConnection, minimalConfigSyncTime time.Duration) bool {
