code-gen-in-docker.sh#!/bin/bash -e
...
PROJECT_MODULE="github.com/kyma-project/kyma/components/system-broker-agent"
IMAGE_NAME="kubernetes-codegen:latest"

CUSTOM_RESOURCE_GROUP_DIR="applicationconnector"
